...
// POST /groups
exports.groupsRouter.post("/", [
    express_validator_1.body("zipcode").isInt({ min: 1, max: 99 }),
    express_validator_1.body("type").matches(enums_1.groupTypeRegex),
], validation_errors_1.validationErrorsController, post_group_controller_1.postGroupRouteController);
// PATCH /groups/:id
exports.groupsRouter.patch("/:id", [
    express_validator_1.body("zipcode").isInt({ min: 1, max: 99 }),
    express_validator_1.body("type").matches(enums_1.groupTypeRegex),
], partial_validation_errors_1.partialValidationErrorsController, patch_group_controller_1.patchGroupRouteController);
// DELETE /groups/:id
